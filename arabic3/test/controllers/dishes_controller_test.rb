...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { ingredients: @dish.ingredients, title: @dish.title } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { ingredients: @dish.ingredients, title: @dish.title } }
